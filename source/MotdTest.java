...
public class MotdTest {
    ...
    static final String API_SITE = "http://cswebcat.swan.ac.uk/puzzle";

    /**
     * Sends a get request and is responsible for handling http status codes. Retrieves the cipher to be sent to
     * 'solve'.
     *
    ...
    private static void sendPost(String solvedKey) throws IOException {
        ...
        while ((line = in.readLine()) != null) {
            ...
            System.out.println("[MOTD] " + line + " [MOTD]");
